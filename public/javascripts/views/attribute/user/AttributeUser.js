...
$(document).ready(function () {
    getAttributeUserList();

    searchHistoryAttributeUser();
});

function getAttributeUserList() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.success && data.content != null) {
                viewAtrributeUserToTable(data.content.attributes);
            } else {
...
function viewAtrributeUserToTable(attrs) {
    console.log(attrs);
    listAttr = new Array;
...
function delAttributeOfOrg() {
    var groupData = new FormData();
    groupData.entity_id = userid;
    groupData.entity_type= "USER";
