...
$(document).ready(function () {
    getAttributeEventList();

    searchHistoryAttributeEvent();
});

function getAttributeEventList() {
    var groupData = new FormData;
    groupData.id = eventId;
    groupData.type = "EVENT";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.success && data.content != null) {
                viewAtrributeEventToTable(data.content.attributes);
            } else {
...
function viewAtrributeEventToTable(attrs) {
    console.log(attrs);
    listAttr = new Array;
...
function processAddAttribute() {
    ...
    formData.entity_id = eventId;
    formData.attribute_key = $("#nameAttrAdd").val();
    formData.entity_type = "EVENT";
...
function delAttributeOfOrg() {
    var groupData = new FormData();
    groupData.entity_id = eventId;
    groupData.entity_type= "EVENT";
