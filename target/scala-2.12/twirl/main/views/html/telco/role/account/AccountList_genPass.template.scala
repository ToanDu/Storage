...
object AccountList_genPass extends _root_.play.twirl.api.BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,_root_.play.twirl.api.Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with _root_.play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
...
Seq[Any](format.raw/*1.1*/("""<div class="modal fade" id="generatePassModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display : none ;">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row g-3">
          <div class="row mt-3">
            <label class="col-sm-4 col-form-label title-section-2">"""),_display_(/*10.69*/Messages("User ID")),format.raw/*10.88*/("""</label>
            <div class="col-sm-12">
              <input id="genId" type="text" class="form-control input-form" readonly>
            </div>
          </div>
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: D:/VHT_Projects/cmp-fe-dev-dev_multiLang/app/views/telco/role/account/AccountList_genPass.scala.html
                  HASH: 957af4b1bc0793df5632279fdb4bfc0fd75a7fde
                  MATRIX: 1063->0|1489->400|1538->429|1748->612|1788->631|2084->900|2129->924|2466->1234|2507->1254
