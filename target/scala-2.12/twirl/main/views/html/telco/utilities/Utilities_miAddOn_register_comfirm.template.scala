...
Seq[Any](format.raw/*1.1*/("""<div class="modal fade" id="comfirmRegisterMiAddonModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" id="theme16">
      <div class="modal-header">
        <h6 class="modal-title">"""),_display_(/*5.34*/Messages("utilities.registerMiAddon")),format.raw/*5.71*/("""</h6>
      ...
      <div class="modal-body text-darker">
        <h6 id="textComfirmRegisterMiAddon">"""),_display_(/*9.46*/Messages("utilities.confirmRegisterMiAddon")),format.raw/*9.90*/("""</h6>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-red" data-bs-dismiss="modal" onclick="processRegisterMiAddon(0)">"""),_display_(/*12.112*/Messages("btnComfirm")),format.raw/*12.134*/("""</button>
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: D:/VHT_Projects/cmp-fe-dev-dev_multiLang/app/views/telco/utilities/Utilities_miAddOn_register_comfirm.scala.html
                  HASH: f144d715357e232124958bda1db341574338c81c
                  MATRIX: 1075->0|1332->231|1389->268|1732->585|1796->629|1987->792|2031->814|2146->902|2189->923
