...
Seq[Any](format.raw/*1.1*/("""<div class="modal fade" id="comfirmOpen1SubsModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" id="theme16">
      <div class="modal-header">
        <h6 class="modal-title">"""),_display_(/*5.34*/Messages("utilities.confirmOpenSubs1")),format.raw/*5.72*/("""</h6>
      </div>
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: D:/VHT_Projects/cmp-fe-dev-dev_multiLang/app/views/telco/utilities/Utilities_openSubs1_comfirm.scala.html
                  HASH: 04dadca190839409ce3c81aa5319fa0cfe6781ef
                  MATRIX: 1068->0|1319->225|1377->263|1715->573|1759->595|1874->683|1917->704
