...
Seq[Any](format.raw/*1.1*/("""<div class="modal fade" id="registerMiAddonModal" data-bs-backdrop="static"  tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" id="theme16">
            <div class="modal-header">
                <h6 class="modal-title">"""),_display_(/*5.42*/Messages("utilities.registerMiAddon")),format.raw/*5.79*/("""</h6>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-cancle" data-bs-dismiss="modal">"""),_display_(/*13.87*/Messages("btnCancel")),format.raw/*13.108*/("""</button>
                <button type="button" class="btn btn-red" onclick="comfirmRegisterMiAddon()">"""),_display_(/*14.95*/Messages("btnComfirm")),format.raw/*14.117*/("""</button>
            </div>
        </div>
    </div>
</div>"""))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: D:/VHT_Projects/cmp-fe-dev-dev_multiLang/app/views/telco/utilities/Utilities_miAddOn_register.scala.html
                  HASH: b2fb5137e035256d3e95ce93e754aebb7553a98e
                  MATRIX: 1067->0|1373->280|1430->317|1972->832|2015->853|2146->957|2190->979
                  LINES: 33->1|37->5|37->5|45->13|45->13|46->14|46->14
                  -- GENERATED --
              */
