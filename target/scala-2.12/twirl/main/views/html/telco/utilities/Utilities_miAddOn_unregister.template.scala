...
Seq[Any](format.raw/*1.1*/("""<div class="modal fade" id="unregisterMiAddonModal" data-bs-backdrop="static"  tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content" id="theme16">
      <div class="modal-header">
        <h6 class="modal-title">"""),_display_(/*5.34*/Messages("utilities.cancelMiAddon")),format.raw/*5.69*/("""</h6>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-red" onclick="comfirmUnregisterMiAddon()">"""),_display_(/*13.89*/Messages("btnComfirm")),format.raw/*13.111*/("""</button>
      </div>
    </div>
  </div>
</div>"""))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: D:/VHT_Projects/cmp-fe-dev-dev_multiLang/app/views/telco/utilities/Utilities_miAddOn_unregister.scala.html
                  HASH: f74d8d79e256095756d9af031168951b045553ea
                  MATRIX: 1069->0|1357->262|1412->297|1892->750|1935->771|2060->869|2104->891
