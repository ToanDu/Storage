...
object AttributeEvent_del extends _root_.play.twirl.api.BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,_root_.play.twirl.api.Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with _root_.play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
...
Seq[Any](format.raw/*1.1*/("""<div class="modal fade" id="deleteAttributeConfirm" tabindex="-1" aria-hidden="true">
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: D:/VHT_Projects/cmp-fe-dev-dev_multiLang/app/views/iot/attribute/event/AttributeEvent_del.scala.html
