...
function sendRegister(){
    ...
    if(data.username == undefined || data.username == null || data.username == ""){
        showNotification('danger',Messages("Hãy điền email của bạn"));
        $("#inputUsername").focus();
        return;
    }
    ...
    var r = jsRoutes.controllers.Application.newRegisterPost();
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if(data.success){
                ...
                var second = 180;
                var link = document.getElementById('buttonGetOtpEmail');
                ...
                var myTimer = setInterval(function () {
                    if(second > 0){
                        $("#buttonGetOtpEmail").html("Nhập OTP (" + second + ")");
                        second--;
                        $("#buttonGetOtpEmail")[0].disabled = true
                    } else {
                        $("#buttonGetOtpEmail").html("Nhận mã OTP");
                        clearInterval(myTimer);
                        $("#buttonGetOtpEmail")[0].disabled = false;
                    }
                },1000);
